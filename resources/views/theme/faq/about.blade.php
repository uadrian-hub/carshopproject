            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="about__feature__item">
                        <img src="{{asset('theme/img/about/af-1.png')}}" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="about__feature__item">
                        <img src="{{asset('theme/img/about/af-2.png')}}" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="about__feature__item">
                        <img src="{{asset('theme/img/about/af-3.png')}}" alt="">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="about__pic">
                    <img src="{{asset('theme/img/about/about-pi')}}c.jpg" alt="">
                </div>
            </div>
...
<!-- Call Section Begin -->
<section class="call spad set-bg" data-setbg="{{asset('theme/img/about/call-bg.jpg')}}">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="team__item">
                    <div class="team__item__pic">
                        <img src="{{asset('theme/img/about/team-1.jpg')}}" alt="">
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="team__item">
                    <div class="team__item__pic">
                        <img src="{{asset('theme/img/about/team-2.jpg')}}" alt="">
                    </div>
                    <div class="team__item__text">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="team__item">
                    <div class="team__item__pic">
                        <img src="{{asset('theme/img/about/team-3.jpg')}}" alt="">
                    </div>
                    <div class="team__item__text">
                        <h5>Sean Robbins</h5>
                        <span>Manager</span>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="team__item">
                    <div class="team__item__pic">
                        <img src="{{asset('theme/img/about/team-4.jpg')}}" alt="">
                    </div>
                    <div class="team__item__text">
                        <h5>Lucy Myers</h5>
                        <span>Delivary</span>
            ...
            <div class="testimonial__slider owl-carousel">
                    ...
                    <div class="testimonial__item">
                        <div class="testimonial__item__author">
                            <div class="testimonial__item__author__pic">
                                <img src="{{asset('theme/img/testimonial/testimonial-1.png')}}" alt="">
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="testimonial__item">
                        <div class="testimonial__item__author">
                            <div class="testimonial__item__author__pic">
                                <img src="{{asset('theme/img/testimonial/testimonial-2.png')}}" alt="">
                            </div>
                            <div class="testimonial__item__author__text">
                                <div class="rating">
                                    <i class="fa fa-star"></i>
...
<!-- Counter Begin -->
<div class="counter spad set-bg" data-setbg="{{asset('theme/img/counter-bg.jpg')}}">
    <div class="container">
        <div class="row">
